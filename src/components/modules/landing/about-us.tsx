...
const AboutUs = () => {
  return (
    <section className="container mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12 py-20">
      <motion.img
        src="/consult.jpg"
        alt="Vite logo"
        className="md:w-52 lg:w-[45rem] drop-shadow-md"
